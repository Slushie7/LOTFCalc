...
def print_help() -> None:
    print(
        'LOTFCalcExtractor for Lords of the Fallen (https://github.com/Slushie7/LOTFCalc)'
    )
    print()
    print(
    ...
    print('E.g.:')
    print('python -m LOTFCalcExtractor "C:\\FModel\\Output\\Exports\\LOTF2"')
...
def main() -> None:
    if args := sys.argv[1:]:
        try:
            ...
            options = args[2:]
            LOTFExtractor(content_dir, mode, *options)
